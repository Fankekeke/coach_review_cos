          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.tagName" placeholder="请输入所属方向"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-select v-model="queryParams.taskType" placeholder="请选择任务类型" allowClear>
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.staffName" placeholder="请输入教练姓名"/>
              </a-form-item>
            </a-col>
          </div>
...
import BulletinAdd from './SubmissionAdd.vue'
import BulletinEdit from './SubmissionEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/assessment-submission/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/assessment-submission/page', {
        ...params
      }).then((r) => {
