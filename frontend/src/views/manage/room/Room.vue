...
import BulletinAdd from './RoomAdd.vue'
import BulletinEdit from './RoomEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/discussion-room/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/discussion-room/page', {
        ...params
      }).then((r) => {
