...
export default {
  ...
  methods: {
    ...
    loadMessages (hotelId, userId, studentId, hotelUserId) {
      ...
      this.$get(`/business/chat-record/list`, param).then((r) => {
    ...
    sendMsg (teacherId, studentId) {
      ...
      if (this.currentUser.userInfoId == teacherId) {
        params.toUserId = studentId
        params.userId = teacherId
      }
      if (this.currentUser.userInfoId == studentId) {
        params.toUserId = teacherId
