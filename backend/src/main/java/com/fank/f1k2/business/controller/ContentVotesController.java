...
public class ContentVotesController {
    ...
    public R queryVotesByUser(Integer userId, Integer questionId) {
        ...
        return R.ok(bulletinInfoService.list(Wrappers.<ContentVotes>lambdaQuery().eq(ContentVotes::getUserId, staffInfo.getId()).in(ContentVotes::getAnswerId, answerIds)));
    }
    ...
    public R save(ContentVotes addFrom) {
        StaffInfo userInfo = staffInfoService.getOne(Wrappers.<StaffInfo>lambdaQuery().eq(StaffInfo::getUserId, addFrom.getUserId()));
        ...
        StaffInfo notifyUserInfo = staffInfoService.getOne(Wrappers.<StaffInfo>lambdaQuery().eq(StaffInfo::getId, partyAnswers.getUserId()));
